            ...
            <nav class="iq-sidebar-menu">
                <ul id="iq-sidebar-toggle" class="iq-menu">
                    ...
                    <li><a href="{{ route('investments-packages.index') }}" class="iq-waves-effect">
                        <i class="las la-money-bill iq-arrow-left"></i><span>Investment Packages</span></a></li>
                    <li><a href="{{ route('admin.account-settings') }}" class="iq-waves-effect">
                            <i class="las la-gear iq-arrow-left"></i><span>Account Settings</span></a></li>
            ...
            <nav class="navbar navbar-expand-lg navbar-light p-0">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-list">
                        ...
                        <li><a style="font-size: 12px; margin-top: 20px;" href="{{ route('users-dashboard') }}">
                                <span>Dashboard</span></a></li>
                        <li><a style="font-size: 12px; margin-top: 20px;" href="{{ route('manage-users') }}">
                                <span>Manage Users</span></a></li>
                        <li><a style="font-size: 12px; margin-top: 20px;" href="{{ route('manage-investments') }}">
                                <span>Manage Investments</span></a></li>
                        <li><a style="font-size: 12px; margin-top: 20px;" href="{{ route('withdrawal-requests') }}">
                                <span>Withdrawal Requests</span></a></li>
                        <li><a style="font-size: 12px; margin-top: 20px;" href="{{ route('investments-packages.index') }}">
                                <span>Investment Packages</span></a></li>
