...
<head>
    ...
    <title>@yield('title') | Bitcoin Market Traders </title>

    <link rel="icon" type="image/x-icon" href="{{ asset('main/images/btcmarkettraders_favicon.png') }}"/>
    ...
    <header class="header navbar navbar-expand-sm">
        ...
        <div class="nav-logo align-self-center">
            <a class="navbar-brand" href="{{ url('/') }}">
                <img alt="logo" src="{{ asset('main/images/btcmarkettraders_favicon.png') }}" width="100">
...
<div class="main-container" id="container">
        ...
        <nav id="topbar">
            <ul class="navbar-nav theme-brand flex-row  text-center">
                <li class="nav-item theme-logo">
                    <a href="{{ url('/') }}">
                        <img src="{{ asset('main/images/btcmarkettraders_favicon.png') }}" class="navbar-logo" alt="logo">
                    </a>
                </li>
                <li class="nav-item theme-text">
                    <a href="{{ url('/') }}" class="nav-link"> BMT </a>
                </li>
            </ul>
            ...
            <ul class="list-unstyled menu-categories" id="topAccordion">
                ...
                <li class="menu single-menu">
                    ...
                    <ul class="collapse submenu list-unstyled" id="app" data-parent="#topAccordion">
                        <li>
                            <a href="{{ route('investments.index') }}"> Your Investments </a>
                        </li>
                        <li>
                ...
                <li class="menu single-menu">
                    <a href="{{ url('users/withdrawal') }}" aria-expanded="false" class="dropdown-toggle">
                        <div class="">
    ...
    <!--  BEGIN CONTENT PART  -->
    <div id="content" class="main-content" style="background-color: #1D1D1D;">
